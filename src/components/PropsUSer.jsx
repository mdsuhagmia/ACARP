    ...
    <>
      <Col lg={4}>
        <div style={{ backgroundColor: 'rgb(255, 255, 255)', marginBottom: '40px', borderRadius: '30px', boxShadow: '20px 20px 120px rgba(0, 0, 0, 0.2)', border: '2px solid rgba(132, 84, 245, 0.21)' }}>
          ...
          <div className='ps-3 pt-1'> {show == true ? <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem eum alias blanditiis</p> : "" } <button style={{border: 'none', marginBottom: '15px', backgroundColor: 'white'}} onClick={handleShow}>Read more</button> </div>
        </div>
      </Col>
    </>
  )
