    ...
    <>
      <Col lg={4}>
        <div style={{ height: '298px', backgroundColor: 'rgb(255, 255, 255)', marginBottom: '40px', borderRadius: '30px', boxShadow: '20px 20px 120px rgba(0, 0, 0, 0.2)', border: '2px solid rgba(132, 84, 245, 0.21)' }}>
          ...
          <div className='ps-3 pt-1'><Button onClick={handleShow} className='ps-4 pe-4' variant="primary">Read more </Button> {show == true ? <p style={{paddingTop: '10px'}}>Lorem ipsum dolor sit consectetur.</p> : "" }</div>
        </div>
      </Col>
    </>
  )
